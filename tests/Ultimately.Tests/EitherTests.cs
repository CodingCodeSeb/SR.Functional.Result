namespace Ultimately.Tests
{
    ...
    public class EitherTests
    {
        ...
        public void Either_GetValueLazy()
        {
            ...
            Assert.Equal(noneStruct.ValueOr(() => -1), -1);
        ...
        public void Either_Matching()
        {
            ...
            none.Match(
                some: val => Assert.True(false, "Failed"),
            ...
            some.Match(
                ...
                none: e => Assert.True(false, "Failed")
            );

            Assert.True(hasMatched);

            none.MatchSome(val => Assert.True(false, "Failed"));
            ...
            some.MatchNone(e => Assert.True(false, "Failed"));
