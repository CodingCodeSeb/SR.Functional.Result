namespace Ultimately
{
    ...
    public static class OptionExtensions
    {
        ...
        public static Option<TValue> Flatten<TValue>(this Option<Option<TValue>> nestedOption) =>
        ...
        public static Option<TResult> Map<TResult>(this Option option, Func<TResult> mapping, Error childError = null)
        {
        ...
        /// <param name="childError">If the resulting optional is empty, sets its error as the direct reason to the specified subsequent error.<para>Example: "Failed to create object" (child error), Caused by: "Timed out while connecting to service" (antecedent optional with an unsuccessful outcome)</para></param>
        /// <returns>The transformed optional.</returns>
        public static Option<TResult> Map<TResult>(this Option option, Func<Success, TResult> mapping, Error childError = null)
        {
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
        ...
        /// <param name="childError">If the resulting optional is empty, sets its error as the direct reason to the specified subsequent error.<para>Example: "Failed to create object" (child error), Caused by: "Timed out while connecting to service" (antecedent optional with an unsuccessful outcome)</para></param>
        /// <returns>The transformed optional.</returns>
        public static Option<TResult> FlatMap<TResult>(this Option option, Func<Option<TResult>> mapping, Error childError = null)
        {
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
            ...
            {
                result = Optional.None<TResult>(childError != null ? childError.CausedBy(option.Error) : option.Error);
            }
        ...
        /// <param name="childError">If the resulting optional is empty, sets its error as the direct reason to the specified subsequent error.<para>Example: "Failed to create object" (child error), Caused by: "Timed out while connecting to service" (antecedent optional with an unsuccessful outcome)</para></param>
        /// <returns>The transformed optional.</returns>
        public static Option<TResult> FlatMap<TResult>(this Option option, Func<Success, Option<TResult>> mapping, Error childError = null)
        {
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
        ...
        /// <returns>The transformed optional.</returns>
        public static Option FlatMap<TValue>(this Option<TValue> option, Func<TValue, Option> mapping, Error childError = null)
        {
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
        ...
        /// <param name="childError">If the resulting optional's outcome is unsuccessful, sets its error as the direct reason to the specified subsequent error.<para>Example: "Operation failed" (child error), Caused by: "The name property cannot be null" (antecedent empty optional)</para></param>
        /// <returns>The transformed optional.</returns>
        public static Option FlatMap<TValue>(this Option<TValue> option, Func<TValue, Success, Option> mapping, Error childError = null)
        {
            if (mapping == null) throw new ArgumentNullException(nameof(mapping));
