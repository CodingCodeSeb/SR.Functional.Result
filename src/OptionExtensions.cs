namespace Ultimately
{
    ...
    public static class OptionExtensions
    {
        ...
        public static Option<TValue> SomeWhen<TValue>(this TValue value, Predicate<TValue> predicate, string errorMessage)
        {
            if (predicate == null) throw new ArgumentNullException(nameof(predicate));

            return predicate(value) ? Optional.Some(value) : Optional.None<TValue>(errorMessage);
        }
        ...
        /// <summary>
        /// Creates an <see cref="Option{TValue}"/> instance from a specified value. 
        /// <para>If the value satisfies the given predicate, an empty optional is returned with the specified error message.</para>
        /// </summary>
        /// <param name="value">The value to wrap.</param>
        /// <param name="predicate">The predicate.</param>
        /// <param name="errorMessage">A description of why the optional is missing its value if the predicate is satisfied.</param>
        /// <returns>An optional containing the specified value, if the predicate is not satisifed.</returns>
        public static Option<TValue> NoneWhen<TValue>(this TValue value, Predicate<TValue> predicate, string errorMessage)
        {
            if (predicate == null) throw new ArgumentNullException(nameof(predicate));

            return value.SomeWhen(val => !predicate(val), errorMessage);
        }
        ...
        /// <summary>
        /// Creates an <see cref="Option{TValue}"/> instance from a specified value. 
        /// <para>If the value is null, an empty optional is returned with the specified error message.</para>
        /// </summary>
        /// <param name="value">The value to wrap.</param>
        /// <param name="errorMessage">A description of why the optional is missing its value if the predicate is satisfied.</param>
        /// <returns>An optional containing the specified value given that it's not null.</returns>
        public static Option<TValue> SomeNotNull<TValue>(this TValue value, string errorMessage) => value.SomeWhen(val => val != null, errorMessage);
        ...
        /// <para>If its value is null, an empty optional is returned with the specified error message.</para>
        /// </summary>
        /// <param name="value">The Nullable&lt;T&gt; instance.</param>
        /// <param name="errorMessage">A description of why the optional is missing its value if the predicate is satisfied.</param>
        /// <returns>The <see cref="Option{TValue}"/> instance.</returns>
        public static Option<TValue> ToOption<TValue>(this TValue? value, string errorMessage)
            where TValue : struct
            => value.HasValue ? Optional.Some(value.Value) : Optional.None<TValue>(errorMessage);
        ...
        public static Option<TResult> Map<TResult>(this Option option, Func<TResult> mapping)
        {
